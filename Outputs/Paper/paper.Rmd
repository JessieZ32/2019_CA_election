...
abstract: |
  | Turnout rate has been always playing an important role in democratic 
  election system. In this paper, we are going to figure out what outcome
  would occur if every qualified voters voted in 2019 Canadian Federal election.
  We will use multilevel regression with post-stratification techniques to 
  estimate the vote share that Liberal would win if the turnout rate is 100%.
  We will also discuss about the importance of turnout rate at last.
  |
  | **Keywords:** 2019 Canadian Federal Election; Liberal; Turnout; Multilevel 
